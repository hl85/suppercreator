...
description: First-time setup flow for x-to-markdown preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| User | `~/.super-creator/x-to-markdown/EXTEND.md` | All projects |
| Project | `.super-creator/x-to-markdown/EXTEND.md` | Current project |
